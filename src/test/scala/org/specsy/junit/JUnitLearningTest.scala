...
class JUnitLearningTest {
  ...
  val eventsRunOrder1 = Buffer(
    "testRunStarted",
    "testStarted test1(org.specsy.junit.DummyTest1)",
    "testFinished test1(org.specsy.junit.DummyTest1)",
    "testStarted test2(org.specsy.junit.DummyTest2)",
    "testFinished test2(org.specsy.junit.DummyTest2)",
    "testStarted test3(org.specsy.junit.DummyTest2)",
    "testFinished test3(org.specsy.junit.DummyTest2)",
    "testRunFinished")
  ...
  def values_returned_by_suite_runners() {
    ...
    assertThat(desc.getDisplayName, is("org.specsy.junit.DummySuite"))

    // contains the full tree of suites and tests
    val children = desc.getChildren
    assertThat(children.size, is(2))
    assertThat(children.get(0).getDisplayName, is("org.specsy.junit.DummyTest1"))
    assertThat(children.get(0).getChildren.size, is(1))
    assertThat(children.get(1).getDisplayName, is("org.specsy.junit.DummyTest2"))
